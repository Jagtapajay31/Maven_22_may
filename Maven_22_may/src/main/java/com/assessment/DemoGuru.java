...
public class DemoGuru {
	...
	public String[][] readdata() throws InvalidFormatException, IOException {
		String data[][]=null;
		//1.to get a filepath
		String filepath="C:\\Users\\os\\eclipse-workspace\\Maven_22_may\\ExcelFile\\Assessment_DemoGuru.xlsx";
		//2.to make file
	...
	public void test() throws InterruptedException, InvalidFormatException, IOException, HeadlessException, AWTException {
        ...
        Thread.sleep(5000);
        	 ...
        	 if (driver.getCurrentUrl().equals("https://www.demo.guru99.com/V4/manager/Managerhomepage.php")) {
             	...
             	Files.copy(file,new File("C:\\Users\\os\\eclipse-workspace\\Maven_22_may\\Screenshot\\PassLogin.jpg"));	
            	...
            	Alert a1=driver.switchTo().alert();
      			File file=((RemoteWebDriver) driver).getScreenshotAs(OutputType.FILE);
              	Files.copy(file,new File("C:\\Users\\os\\eclipse-workspace\\Maven_22_may\\Screenshot\\FailLogin.jpg"));
